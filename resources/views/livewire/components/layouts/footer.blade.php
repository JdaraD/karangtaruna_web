        ...
        <div class="grid grid-cols-3 h-full py-2 gap-4 size-[90%]">
            ...
            <div class="h-full">
                ...
                <div class="h-[90%]">
                    ...
                    {{-- address --}}
                    <p class="lg:text-xs md:text-[10px] text-[8px] font-[poppins] font-medium text-white normal-case text-justify pb-4">Jl. H. Mawi Desa Waru Rt.02/01 Kecamatan. Parung kabupaten. Bogor. Jawa Barat 16330</p>
                    {{-- address --}}
                    ...
                    <div class="flex gap-2 mb-2">
                        ...
                        <address class="lg:text-xs md:text-[10px] text-[8px] font-[poppins] font-medium text-white">(+62)800058xxx</address>
                    ...
                    <div class="flex gap-2">
                        ...
                        <address class="lg:text-xs md:text-[10px] text-[8px] font-[poppins] font-medium text-white">email@gmail.com</address>
